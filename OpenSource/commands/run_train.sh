...
# job_name="OSPass512"
# pretrained_checkpoint_dir="/mnt/azureblob/lexion/glue_data/MSMarcoANN/OSPass512/checkpoint-260000/"
# data_type=1
# warmup_steps=5000
...
# tokenizer_type="roberta-base"
# model_type=rdot_nll
# base_data_dir="/mnt/azureblob/lexion/glue_data/MSMarcoDocANN/"
# preprocessed_data_dir="${base_data_dir}ann_data_${tokenizer_type}_${seq_length}/"
# job_name="OSDoc512"
# pretrained_checkpoint_dir="/mnt/azureblob/lexion/glue_data/MSMarcoDocANN/jialliu/checkpoint-60000/"
# data_type=0
# warmup_steps=3000
# per_gpu_train_batch_size=8
# gradient_accumulation_steps=2
...
base_data_dir="/mnt/azureblob/lexion/glue_data/MSMarcoDocANN/"
preprocessed_data_dir="${base_data_dir}ann_data_${tokenizer_type}_${seq_length}_debug/"
job_name="OSDoc2048"
pretrained_checkpoint_dir="/mnt/azureblob/lexion/glue_data/MSMarcoDocANN/OSDoc2048/checkpoint-130000"
data_type=0
warmup_steps=500
